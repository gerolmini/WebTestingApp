...
public static void initSystemProperties() {
	// Collect path to drivers
	Path currentRelativePath = Paths.get("");
	String geckoPath = Paths.get(currentRelativePath.toAbsolutePath().toString(),
			"drivers/geckodriver").toString();
	String chromePath = Paths.get(currentRelativePath.toAbsolutePath().toString(),
			"drivers/chromedriver").toString();
	...
	System.out.println("GeckoDriver path: " + geckoPath);
