...
public class Assignment {
	...
	private static Duration longTimeout =  Duration.ofSeconds(55);
...
//		ChromeDriver driver = (ChromeDriver) WebTesting.launchDriver("https://www.google.com", "chrome");
		...
		try {
		longWait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//div[@class='lv7K9c']")));
		...
		try {
			shortWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//g-raised-button[@jsaction=\'iyDKIb\']"))); // mal
...
//		}
		...
		driver.findElement(By.xpath("//div[@jsname=\'rk7b0d\']")).click();
		try {
			shortWait.until(ExpectedConditions.textToBePresentInElement(calculatorText, "log(58 × 6 ÷ 2 - 7"));
		} catch (TimeoutException ex) {
			fail("\"7\" was not the intermediate solution.");
		}
...
//		ChromeDriver driver = (ChromeDriver) WebTesting.launchDriver("https://www.google.com", "chrome");
		...
		driver.findElement(By.cssSelector("div[jsname=\'lVjWed\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'87 * 2\']"));
		} catch (NoSuchElementException ex) {
			fail("\"2\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname=\'N10B9\']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'87 * 21\']"));
		} catch (NoSuchElementException ex) {
			fail("\"1\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname='T7PMFe']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'58\']"));
		} catch (NoSuchElementException ex) {
			fail("\"8\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname='abcgof']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'58 × 6\']"));
		} catch (NoSuchElementException ex) {
			fail("\"6\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname='lVjWed']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'58 × 6 ÷ 2\']"));
		} catch (NoSuchElementException ex) {
			fail("\"2\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname='rk7b0d']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'58 × 6 ÷ 2 - 7\']"));
		} catch (NoSuchElementException ex) {
			fail("\"7\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname='xAP7E']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'58 × 6 ÷ 2 - 74\']"));
		} catch (NoSuchElementException ex) {
			fail("\"4\" was not input.");
		}
		...
		driver.findElement(By.cssSelector("div[jsname='Pt8tGc']")).click();
		try {
			driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'100\']"));
		} catch (NoSuchElementException ex) {
			fail("\"100\" was not the solution.");
		}
	}
}
